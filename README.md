...
# Скриншоты работы программы :smiley_cat:
...
:smiley:Проблем с проведением тестов не возникло.:smiley:

:smiley:После запуска тестов в **обозревателе тестов** все тесты были выполнены успешно. :smiley:
